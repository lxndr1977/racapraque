<x-layouts.main title="Fale com a gente | Projeto Raça Pra Quê?">
    <x-page-layout>
        <div class="grid grid-cols-1 md:grid-cols-2 items-center py-18 gap-10">
            <div>
                ...
                <h1 class="font-medium text-4xl md:text-5xl mb-4 text-primary">Tem dúvidas ou precisa de alguma informação?</h1>
