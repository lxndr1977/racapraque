<section class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12 mb-64">
    <div class="grid grid-cols-1 md:grid-cols-2 items-center py-18 gap-10">
        <div>
            ...
            <h1 class="font-medium text-4xl md:text-5xl mb-4 text-primary">A sua ajuda salva vidas! Faça uma doação</h1>
        ...
        <div>
            <img src="{{ asset('images/home-faca-uma-doacao.webp') }}" 
                 class="w-full"
                 loading="lazy"
                 width="588"
                 height="419"  
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div class="col-span-1 row-span-1 space-y-3">
            <img src="{{ asset('images/logo-apoiase-home.webp') }}" 
                 alt="Logo Apoia.se" 
                 loading="lazy" 
                 width="178" 
                 height="40" 
        ...
        <div class="col-span-1 row-span-1 space-y-3">
            <img src="{{ asset('images/logo-pix-home.png') }}" 
                 loading="lazy" 
                 width="114" 
                 height="40" 
                 alt="Logo Pix" 
                 class="max-h-10 mb-6 h-auto">
