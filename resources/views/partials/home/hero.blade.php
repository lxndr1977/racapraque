    ...
    <div class="grid grid-cols-1 md:grid-cols-2 items-center  gap-10">
        <div>
            ...
            <div class="flex flex-col md:flex-row gap-6 items-center">
                <x-button type="link" href="{{ route('adoption.index') }}" target="_blank" size="medium" class="w-full md:w-auto">Adote um abrigado</x-button>
                <a href="{{ route('sponsorship.index') }}" class="font-medium text-primary">Não pode adotar? Apadrinhe!</a>
            </div>
        </div>
        <div>
            <img src="{{ asset('images/home-hero-raca-pra-que.webp') }}" class="w-full" alt="Raça Pra Quê">
        </div>
    </div>
</section>